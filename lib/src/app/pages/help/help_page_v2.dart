...
class _HelpPageState extends State<HelpPage>
  ...
  Widget _categoryDetail(
      ...
      String nameService,
      String urlImage,
      ProductWarranty fullWarrantyItem}) {
    var dateFormat;
    if (expireDate != '') {
              ...
              Flexible(
                ...
                child: Container(
                  width: 50,
                    height: 50,
                    child:
//  "http://14.187.122.118:8069/web/image?model=res.partner&field=image&id=8&session_id=2da19ca8fc367d865f268d027310092a85dff941"
                  ...
                  ? Column(
                      ...
                      children: <Widget>[
                        ...viewModel.listProductWarranty.map((item) {
                          print(item.productId[2]);
                          return _categoryDetail(
                              fullWarrantyItem: item,
                              id: item.id,
                              nameService: item.productId[1],
                              createDate: item.warrantyCreateDate,
                              urlImage: viewModel.getImageByProductId(item.productId[0].toString()),
